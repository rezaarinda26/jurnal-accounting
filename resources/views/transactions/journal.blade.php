        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 px-4 sm:px-0">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="mt-4 md:mt-0 flex items-center gap-3">
                    ...
                    <button type="submit" form="journal-filter-form" formaction="{{ route('transactions.export_excel') }}"
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm"
                ...
                <form id="journal-filter-form" action="{{ route('transactions.journal') }}" method="GET"
                    ...
                    <div class="flex items-center gap-2 lg:col-span-4 xl:col-span-1 h-[42px]">
                        ...
                        @if(request()->anyFilled(['pic', 'account_id', 'nominal']) || request('start_date') || request('end_date'))
            ...
            <div
                ...
                <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-700/50 flex flex-row items-center justify-between gap-3">
                                ...
                                <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="mb-1.5 flex flex-wrap gap-1.5">
                                            @if($isKas)
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-black bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border border-blue-200 dark:border-blue-800 uppercase tracking-widest">
                                                    KAS
                                                </span>
                                            @elseif($isHutang)
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-black bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-200 dark:border-amber-800 uppercase tracking-widest">
                                                    HUTANG
                                                </span>
                                            @endif
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        ...
                                        @endphp
                                        <span class="font-black text-slate-800 dark:text-slate-100 text-base">

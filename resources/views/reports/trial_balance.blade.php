        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 px-4 sm:px-0">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Ringkasan mutasi debit dan kredit seluruh
                        kategori akun.</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('reports.trial_balance.export') }}"
                        class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold text-xs transition-all shadow-md active:scale-95 uppercase tracking-wide"
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center text-slate-400 dark:text-slate-500">
                                        ...
                                        <span
                                            class="mt-2 block text-sm font-medium text-slate-800 dark:text-slate-200">Belum
                                            Ada Transaksi</span>
                                    </td>
                                </tr>
                            @endforelse
